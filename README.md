...
There is however no good reason to use 2.7 over 3.0.0-rc5, so please start with the rc-version.

3.0.0-rc5 is better than 2.7 in any aspect and the code is production-ready.
...
`npm install --save @rx-signals/store@3.0.0-rc5`
