...
There is however no good reason to use 2.x over 3.0.0-rc9, so please start with the rc-version (3.0.0 will be the first version I'm going to advertise publicly, so it's more like a 1.0 in reality).
