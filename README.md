...
There is however no good reason to use 2.x over 3.0.0-rc10, so please start with the rc-version (3.0.0 will be the first version I'm going to advertise publicly, so it's more like a 1.0 in reality).

3.0.0-rc10 is better than 2.x in any aspect and the code is production-ready.
...
**`npm install --save @rx-signals/store@3.0.0-rc10`**
